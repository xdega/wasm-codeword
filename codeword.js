...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'codeword.wast';
  var wasmBinaryFile = 'codeword.wasm';
  var asmjsCodeFile = 'codeword.temp.asm.js';
...
STATICTOP = STATIC_BASE + 26640;
/* global initializers */  __ATINIT__.push({ func: function() { __GLOBAL__sub_I_codeword_cpp() } }, { func: function() { __GLOBAL__sub_I_bind_cpp() } });
...
var real___GLOBAL__sub_I_codeword_cpp = asm["__GLOBAL__sub_I_codeword_cpp"]; asm["__GLOBAL__sub_I_codeword_cpp"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real___GLOBAL__sub_I_codeword_cpp.apply(null, arguments);
};
...
var __GLOBAL__sub_I_codeword_cpp = Module["__GLOBAL__sub_I_codeword_cpp"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["__GLOBAL__sub_I_codeword_cpp"].apply(null, arguments) };
